...
public class Zadacha3 {
    public Zadacha3(){
        ...
        if(num == a){
            ...
            if (num1 == b){ System.out.println("Среднее значение - " + b + " Минимальное значение - " + c);
            }else System.out.println("Среднее значение - " + c + " Минимальное значение - " + b);

        } else if (num == b) {System.out.println("Самое большое значение - " + b);
            int num1 = Math.max(c,a);
            if (num1 == a){ System.out.println("Среднее значение - " + a + " Минимальное значение - " + c);
            }else System.out.println("Среднее значение - " + c + " Минимальное значение - " + a);
        } else {System.out.println("Самое большое значение - " + c);
            int num1 = Math.max(b,a);
            if (num1 == a){ System.out.println("Среднее значение - " + a + " Минимальное значение - " + b);
