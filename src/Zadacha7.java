...
public class Zadacha7 {
    public Zadacha7(){
        ...
        if (d < 0){System.out.println("У уравнения нет действительных корней.");
            System.out.println("Дискриминант = " + d);

        } else if (d == 0) {System.out.println("У уравнения два равных корня");
            double koren = ((double) b / (2 * a));
            System.out.println("Дискриминант = " + d + " Корень = " + koren);
        } else if (d > 0) {System.out.println("У уравнения два различных корня");
